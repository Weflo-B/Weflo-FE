  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <InsuranceContent
          header={Dummy.insuranceContent.header}
          subHeader={Dummy.insuranceContent.subHeader}
          labels={Dummy.insuranceContent.labels}
        />
        <InsuranceContent
          header={Dummy.insuranceTerm.header}
          subHeader={Dummy.insuranceTerm.subHeader}
          labels={Dummy.insuranceTerm.labels}
        />
      </div>
